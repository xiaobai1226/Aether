...
public class ResultErrorMsgConsts {
     ...
     * 密码格式错误
     */
    public static final String ERROR_PASSWARD_FORMAT = "密码格式不正确，只允许由" + VerifyConsts.PASSWORD_MIN_LENGTH + "到" + VerifyConsts.PASSWORD_MAX_LENGTH + "位的组合构成，必须包含至少一个小写字母，一个大写字母，一个数字，以及一个特殊字符,特殊字符包括!@#$%^&*()<>?";
     ...
     * 邮箱长度错误
     */
    public static final String ERROR_EMAIL_LENGTH = "邮箱长度不能超过" + VerifyConsts.EMAIL_LENGTH + "个字符";
     ...
     * 用户名格式错误
     */
    public static final String ERROR_USERNAME_FORMAT = "用户名格式不正确，只允许由" + VerifyConsts.USERNAME_MIN_LENGTH + "到" + VerifyConsts.USERNAME_MAX_LENGTH + "位的组合构成，必须以字母开头，其余可以是字母、数字、-或~";

    /**
     * 用户ID为空错误
     */
    public static final String ERROR_USER_ID_EMPTY = "用户ID不能为空";
     ...
     * 昵称长度错误
     */
    public static final String ERROR_NICKNAME_LENGTH = "昵称长度不能超过" + VerifyConsts.NICKNAME_MAX_LENGTH + "个字符";
     ...
     * 文件(夹)名称长度错误
     */
    public static final String ERROR_FILE_NAME_LENGTH = "文件(夹)名称长度不能超过" + VerifyConsts.FILE_NAME_MAX_LENGTH;
