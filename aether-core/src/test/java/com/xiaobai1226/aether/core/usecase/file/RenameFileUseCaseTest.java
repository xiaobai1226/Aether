...
// when(userFileService.getUserFileByName(newName, userId,
// existingFile.getParentId(), NORMAL))
...
// // Then
// verify(userFileService).rename(fileId, userId, newName, existingFile,
// NORMAL);
// }
...
// when(userFileService.getUserFileByIdAndUserId(fileId, userId, NORMAL))
// .thenReturn(existingFile);
// when(userFileService.getUserFileByName(sameName, userId,
// existingFile.getParentId(), NORMAL))
...
// // Then
// verify(userFileService).rename(fileId, userId, sameName, existingFile,
// NORMAL);
// }
